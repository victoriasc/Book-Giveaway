/*
  ...
  as the visitor picks a sort order or clicks tag filters.
*/
...
function renderCards(books) {
  ...
  if (books.length === 0) {
    ...
    empty.textContent = "No books match that filter.";
...
function applyAndRender() {
  ...
  const filtered = filterBooksByTags(allBooks, activeTags);
